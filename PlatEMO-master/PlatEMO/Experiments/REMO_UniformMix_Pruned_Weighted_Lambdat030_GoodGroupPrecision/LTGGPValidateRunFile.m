function [isValid, report] = LTGGPValidateRunFile(filePath, expectedProfile)
%LTGGPVALIDATERUNFILE Validate one atomic Good-group Precision result MAT.
    ...
    if string(data.metadata.AlgorithmClass) ~= "LTGGPAudit"

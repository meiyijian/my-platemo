function comparison = LTGGPComparePaired(valuesA, valuesB)
%LTGGPCOMPAREPAIRED Summarize a paired, higher-is-better comparison.
...
%   valid pair before averaging.
    ...
    if numel(valuesA) ~= numel(valuesB)
        error("LTGGP:UnpairedInput", "valuesA and valuesB must have equal lengths.");
    end

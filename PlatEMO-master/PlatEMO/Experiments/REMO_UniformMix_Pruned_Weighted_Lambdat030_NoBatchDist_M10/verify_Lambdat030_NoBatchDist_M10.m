function verify_Lambdat030_NoBatchDist_M10()
...
%   N=100, maxFE=300, SaveCount=30.
    ...
    writetable(T,fullfile(outDir,'summary_Lambdat030_NoBatchDist_M10.csv'));
    fprintf('Summary written: %s\n',fullfile(outDir,'summary_Lambdat030_NoBatchDist_M10.csv'));
end

function v = meanFinite(v)
    v = v(isfinite(v));
    if isempty(v), v = NaN; else, v = mean(v); end
end

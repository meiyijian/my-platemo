function verify_Lambdat030_NoBatchDist_M15()
%Full integrity check of the 320 stored MAT files (no result analysis).
%   Files: D:\REMOandDREMO测试集\15目标\REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist
%   16 problems (DTLZ1-7, WFG1-9) x 20 runs, M=15, D=30 (WFG2/WFG3 -> D=31),
%   N=100, maxFE=300, SaveCount=30.
    D   = 'D:\REMOandDREMO测试集\15目标\REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist';
    ...
    for i = 1:numel(probs)
        ...
        for r = 1:20
            f = '';
            for dd = [30 31]
                cand = fullfile(D,sprintf('%s_%s_M15_D%d_%d.mat',alg,probs{i},dd,r));
    ...
    writetable(T,fullfile(outDir,'summary_Lambdat030_NoBatchDist_M15.csv'));
    fprintf('Summary written: %s\n',fullfile(outDir,'summary_Lambdat030_NoBatchDist_M15.csv'));
end

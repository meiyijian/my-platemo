function run_Lambdat030_NoBatchDist_M20(part,runs,threads)
%Run one slice of the M=20 DTLZ/WFG sweep for the NoBatchDist variant.
%
%   run_Lambdat030_NoBatchDist_M20(PART,RUNS,THREADS)
...
%   which matches the rest of the 20-objective dataset. RUNS may be a vector,
...
%
%   Results : D:\REMOandDREMO测试集\20目标\REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist
%   Logs    : <this folder>\logs   (the dataset folder stays MAT-only)
    ...
    run_UniformMixPrunedFullSeries(part,16, ...
        'OutputRoot','D:\REMOandDREMO测试集\20目标', ...

classdef SAMOEATL2M_N100 < ALGORITHM
...
% N100 variant: the initial design is fixed at 100 points instead of the
% 11*D-1 points used by SAMOEATL2M, so that the algorithm can be compared
% against the others under the same maxFE=300 budget. Nothing else is
% changed with respect to SAMOEATL2M.m.

    methods
        function main(Algorithm,Problem)
            % Fixed initialization requires at least 100 true evaluations.
            assert(Problem.maxFE >= 100,'PlatEMO:InsufficientBudget', ...
                'The _N100 variant requires maxFE >= 100.');
            %% Parameter setting

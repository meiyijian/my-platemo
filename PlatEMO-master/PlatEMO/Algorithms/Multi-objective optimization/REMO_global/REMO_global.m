classdef REMO_global < ALGORITHM
% <2025> <multi/many> <real> <expensive>
% REMO_global: REMO with only global reference vector field scoring
% Ablation study: Uses only score_v from reference vector field
% No label_dyn (PBI-based) is used
    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Archive)
                ...
                % Hybrid classification - only using score_v

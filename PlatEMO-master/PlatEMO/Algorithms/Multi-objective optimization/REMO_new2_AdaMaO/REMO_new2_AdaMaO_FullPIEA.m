classdef REMO_new2_AdaMaO_FullPIEA < ALGORITHM
% <2026> <multi/many> <real> <expensive>
% Full-AdaMaO-PIEA: 完整版本，保留所有机制
%
% 本版本功能等同于 REMO_new2_AdaMaO.m，作为消融实验的基线 (baseline)。
%
% 包含模块：
%  - RuntimeDiagnostics（运行时诊断）
%  - Dynamic relation-pair training（自适应关系对训练）
%  - PIEA-style indicator subsystem（指标子系统）
%  - Dynamic candidate selection（自适应候选选择）
%
% 实验目的：作为完整版本的基准，供其他 4 个消融版本对比。

classdef REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist_PMix075 < ALGORITHM
...
% Fixed pMix = 0.75 (indicator-branch probability when the model is available).
...
% nMax    --- 6    --- Maximum evaluation batch size
    ...
    methods
        function main(Algorithm,Problem)
            ...
            pMix = 0.75; % Fixed by this sensitivity-analysis variant.
            if numel(Algorithm.parameter) > 4
                error('REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist_PMix075:InvalidParameterCount', ...

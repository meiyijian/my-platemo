classdef REMO_UniformMix_Pruned_Weighted_Lambdat050 < ALGORITHM
% <2026> <multi/many> <real> <expensive>
% Pruned quality filter plus a constant ambiguity reward (lambda_t = 0.50).
% Copy of REMO_UniformMix_Pruned_Weighted_Lambdat030 with a single change:
% the reward weight is raised from 0.30 to 0.50. Everything else - PAQC,
% the relation model, candidate generation, the indicator branch, pMix,
...
% nMax    --- 6    --- Maximum evaluation batch size
    ...
    methods
        function main(Algorithm,Problem)
            ...
            ADAMAO_LAMBDAT050_DIAG = struct('enabled',true,'lambdaT',0.50, ...
            ...
            while Algorithm.NotTerminated(Archive)
                ADAMAO_LAMBDAT050_DIAG.rounds = ADAMAO_LAMBDAT050_DIAG.rounds + 1;
                u = rand(modeStream,1);

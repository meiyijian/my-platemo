classdef REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist_PMix100 < ALGORITHM
...
% Fixed pMix = 1.00 (indicator-branch probability when the model is available).
...
% nMax    --- 6    --- Maximum evaluation batch size
    ...
    methods
        function main(Algorithm,Problem)
            ...
            pMix = 1.00; % Fixed by this sensitivity-analysis variant.
            if numel(Algorithm.parameter) > 4
                error('REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist_PMix100:InvalidParameterCount', ...

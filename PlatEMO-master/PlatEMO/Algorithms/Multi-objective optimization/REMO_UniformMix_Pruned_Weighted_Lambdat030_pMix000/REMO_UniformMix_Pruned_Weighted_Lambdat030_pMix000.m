classdef REMO_UniformMix_Pruned_Weighted_Lambdat030_pMix000 < ALGORITHM
...
% to 0.00 as a fixed property of THIS algorithm instead of being
...
% pMix    --- 0.00 --- Indicator-selection probability (PINNED, not a parameter)

classdef REMO_UniformMix_Pruned_Weighted_Lambdat030_pMix075 < ALGORITHM
...
% to 0.75 as a fixed property of THIS algorithm instead of being
...
% pMix    --- 0.75 --- Indicator-selection probability (PINNED, not a parameter)

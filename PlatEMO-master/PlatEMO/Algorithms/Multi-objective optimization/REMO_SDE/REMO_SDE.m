classdef REMO_SDE < ALGORITHM
% <2025> <multi/many> <real> <expensive>
% REMO_SDE: REMO with only SDE performance indicator scoring
% Ablation study: Uses only SDE-based fitness, no PBI or reference vector field
    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Archive)
                ...
                % SDE-based classification (no PBI, no reference vector field)

classdef REMO_UniformMix_Pruned_Weighted_Lambdat030_NoBatchDist < ALGORITHM
...
% filter remain absent, and PAQC, candidate generation, the indicator branch,
% pMix, nMax and the remaining settings stay identical to Lambdat030.

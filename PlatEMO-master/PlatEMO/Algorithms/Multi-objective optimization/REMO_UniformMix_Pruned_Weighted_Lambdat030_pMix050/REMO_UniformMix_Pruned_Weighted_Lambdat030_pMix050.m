classdef REMO_UniformMix_Pruned_Weighted_Lambdat030_pMix050 < ALGORITHM
...
% to 0.50 as a fixed property of THIS algorithm instead of being
...
% pMix    --- 0.50 --- Indicator-selection probability (PINNED, not a parameter)

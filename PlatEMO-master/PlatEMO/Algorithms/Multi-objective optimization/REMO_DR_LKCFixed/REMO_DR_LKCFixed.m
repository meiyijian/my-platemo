classdef REMO_DR_LKCFixed < ALGORITHM
% <2026> <multi/many> <real> <expensive>
% REMO_DiRel_LKC backbone with warm-up then fixed LKC objective reduction.
%
...
% lockGen  --- 3    --- generation at which LKC groups are locked
    ...
    methods
        function main(Algorithm, Problem)
            ...
            DR_RunMain('lkcfixed', Algorithm, Problem, params);
        end
    end

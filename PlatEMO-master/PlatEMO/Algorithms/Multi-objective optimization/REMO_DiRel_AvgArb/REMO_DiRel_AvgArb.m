classdef REMO_DiRel_AvgArb < ALGORITHM
% <2026> <multi/many> <real> <expensive>
% REMO_DiRel 消融变体 4：仲裁器换成 0.5/0.5 简单平均
%
% 用途：证明"逐候选解逆方差权重"的边际贡献 —— 若 DiRel > AvgArb，
% 说明用不确定性自适应权重比固定 0.5/0.5 更好，回应 plan 中缺陷 B 的应对。
%
% 与 REMO_DiRel 的唯一差异：调用本地 ArbitratedSelection_AvgArb
    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Archive)
                ...
                % ---- 消融差异：调用本地的简单平均仲裁 ----
                Next = ArbitratedSelection_AvgArb(Problem, Ref, Input, gmax, Smodel);

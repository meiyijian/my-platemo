...
%   Indicator mode uses the 30-percent relation shortlist and direct ranking.
    ...
    switch Smodel.mode
        case 'explore'
            ...
            [Next,info] = Lambdat030WeightedBatchSelection( ...
...
%   cannot disturb the optimization stream.
    ...
    if ~isstruct(ADAMAO_LAMBDAT030_DIAG) || ...
            ~isfield(ADAMAO_LAMBDAT030_DIAG,'enabled') || ...
            ~ADAMAO_LAMBDAT030_DIAG.enabled
        return;
    end
    info.FE = Problem.FE;
    info.nMax = nMax;
    info.nCandidates = nCandidates;
    ADAMAO_LAMBDAT030_DIAG.iterations = ADAMAO_LAMBDAT030_DIAG.iterations + 1;
    ADAMAO_LAMBDAT030_DIAG.records{end+1} = info;
end

classdef REMO_new2_AdaMaO_SDEOnly_UniformMix_Pruned_qKeep080 < ALGORITHM
% <2026> <multi/many> <real> <expensive>
% PAQC with quality-filtered batch-distance exploration and SDE ranking.
% qKeep=0.80 variant: source-identical to
% REMO_new2_AdaMaO_SDEOnly_UniformMix_Pruned, but frozen at the source default
% qKeep = 0.80. (The earlier "Pruned" results were produced with an explicit
% parameter override qKeep = 0.70, so the two settings need different class
% names to keep their result directories and file prefixes apart.)
...
% qKeep --- 0.80 --- Quantile threshold for exploration relation scores
    ...
    methods
        function main(Algorithm,Problem)
            ...
            [gmax,pMix,rGood,qKeep,nMax] = ...
                Algorithm.ParameterSet(3000,0.50,0.25,0.80,6);

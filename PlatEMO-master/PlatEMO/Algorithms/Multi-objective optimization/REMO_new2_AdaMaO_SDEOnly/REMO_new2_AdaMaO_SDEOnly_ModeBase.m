classdef REMO_new2_AdaMaO_SDEOnly_ModeBase < ALGORITHM
% Shared runtime for the SDE-only candidate-mode ablation variants.
    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Archive)
                ...
                % Keep the original progress for HybridPBI and exploration.

...
function validateProbe(probe,generation,activeIDs,currentNDIDs,isFinal)
    ...
    valid = valid && isnumeric(generation) && isreal(generation) && ...
        ...
        generation == floor(generation) && isnumeric(activeIDs) && ...
        isreal(activeIDs) && all(isfinite(activeIDs(:))) && ...
        isnumeric(currentNDIDs) && isreal(currentNDIDs) && ...
        all(isfinite(currentNDIDs(:))) && ...
        (islogical(isFinal) || isnumeric(isFinal)) && isscalar(isFinal);
    if ~valid

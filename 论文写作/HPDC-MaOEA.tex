...
consistent mean IGD$^+$ advantages on WFG7 and WFG8 across the three objective
counts; PIEA remains stronger on several DTLZ instances. The reported component
...
precision. All 960 PACDIS runs end at 300 evaluations. REMO and CSEA
...
for the PACDIS implementation. PACDIS has the lowest mean IGD$^+$
...
PACDIS and the six baselines on WFG7 and WFG8. The source files match
the main-table run identifiers 1--20.

...
Figure~\ref{fig:hybrid-grouping} illustrates the two PBI definitions and the
resulting positive-group construction with an analytical example.
\input{figures/figure_hybrid_grouping.tex}
...
Figure~\ref{fig:candidate-selection} shows the alternative selection paths
and their common evaluation-budget constraint.
\input{figures/figure_candidate_selection.tex}
...
Figure~\ref{fig:group-evidence} visualises the stagewise means and paired
differences, with uncertainty estimated across complete runs.
\input{figures/figure_group_evidence.tex}
...
Figure~\ref{fig:candidate-evidence} displays the run-level batch diagnostics
together with paired final-IGD ratios relative to relation top-six selection.
\input{figures/figure_candidate_evidence.tex}
